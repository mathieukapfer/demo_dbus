...
test-pong:  build-test
	export LD_LIBRARY_PATH=$(LD_LIBRARY_PATH) && $(BUILD_PATH)/pong &
	sleep 1
	gdbus introspect --session --dest "my.service" --object-path "/path/to/object"
	gdbus call       --session --dest "my.service" --object-path "/path/to/object" --method "my.interface.ping_void"
	gdbus call       --session --dest "my.service" --object-path "/path/to/object" --method "my.interface.ping" "helloo"

test-pong-py:
	python pong.py &
	sleep 1
	gdbus introspect --session --dest "my.service" --object-path "/path/to/object"
	gdbus call --session  --dest "my.service" --object-path "/path/to/object" --method "my.interface.foo"
